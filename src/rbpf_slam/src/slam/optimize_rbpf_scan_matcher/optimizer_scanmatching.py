...
def _init_scan_matching_worker(playback_data: PlaybackData) -> None:
    """
...
def _run_scan_matching_job(job: dict) -> RankedRunScanMatching:
    """
    Run one independent scan-matching optimization job.
    ...
    run_playback_data = ScanMatchingOptimizer._apply_measurement_noise_per_seed(
...
class ScanMatchingOptimizer:
    ...
    def optimize_parallel(
        ...
        executor_kwargs = {
            ...
            "initializer": _init_scan_matching_worker,
