...
SCORER_SUMMARY_DF_MAPPINGS: Dict[str, List[Union[str, bool]]] = {
    ...
    "max_corr_trans_err": ["max_corr_trans_err", False],
    "max_corr_rot_err": ["max_corr_rot_err_deg", True],
    "perc_95_corr_trans_err": ["perc_95_corr_trans_err", False],
    "perc_95_corr_rot_err": ["perc_95_corr_rot_err", True],
    ...
    "final_drift_rot": ["final_drift_rot_deg", True],
}
