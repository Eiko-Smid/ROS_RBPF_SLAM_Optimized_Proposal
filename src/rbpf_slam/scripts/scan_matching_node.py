...
from slam.scan_matcher.icp_scan_matching import IterativeClosestPoint
from slam.scan_matcher.ogm_scan_matching import OGM
from slam.scan_matcher.scan_matcher import ScanMatcher
from slam.scan_matcher.scan_match_playback_def import (
    StepData,
    SensorParam,
    OccupancyParam,
    Metadata,
...
class ScanMatchingNode:
    ...
    def __init__(
            ...
            playback_dir: str = "/home/smide/work/ros_workspaces/ros_ws/src/rbpf_slam/data/scan_match/python_playback/",
            playback_prefix: str = "python_playback",
            meta_data: Metadata = None,
            metric_storage_filename: str = "scan_matching_metric.csv",
            metric_storage_dir: str = "/home/smide/work/ros_workspaces/ros_ws/src/rbpf_slam/data/scan_match/metrics/",
    ) -> None:
...
def main():
    ...
    playback_dir = "/home/smide/work/ros_workspaces/ros_ws/src/rbpf_slam/data/scan_match/python_playback/"
    playback_prefix = "python_playback"
    metric_storage_filename = "scan_matching_metric.csv"
    metric_storage_dir = "/home/smide/work/ros_workspaces/ros_ws/src/rbpf_slam/data/scan_match/metrics/"
