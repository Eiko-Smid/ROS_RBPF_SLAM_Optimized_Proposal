...
class OGMROSCommunication():
    def __init__(self, map_parameter, occupancy_parameter, ros_parameter, sensor_parameter):
        ...
        self.subscriber= rospy.Subscriber("gazebo/link_states", LinkStates, self.read_link_data)
    ...
    def read_link_data(self, link_states):
        ...
        # if(not self.first_call_of_callback):
        #     self.first_call_of_callback= True
        #     rospy.loginfo("Link state name is: %s", self.link_state_message.name[2])
